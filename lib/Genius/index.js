...
var GeniusClient = /** @class */ (function () {
    ...
    GeniusClient.prototype.InitiateTransaction = function (TransportKey) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                url = "https://" + this.config.CEDHostname + "/v2/pos?" + queryString;
                return [2 /*return*/, fetch(url).then(function (r) {
                        if (r.status !== 400) {
                            return r.json();
                        }
                        else {
     ...
     * Check the status of the CED
     */
    GeniusClient.prototype.CheckStatus = function (timeout) {
        return __awaiter(this, void 0, void 0, function () {
            var params, queryString, url;
            return __generator(this, function (_a) {
                switch (_a.label) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        queryString = makeQueryString(params);
                        url = "https://" + this.config.CEDHostname + "/v1/pos?" + queryString;
     ...
     */
    GeniusClient.prototype.Cancel = function (timeout) {
 ...
 */
function impatientFetch(url, timeout) {
    if (timeout === void 0) { timeout = 5000; }
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, bluebird_1.default.resolve(fetch(url)).timeout(timeout, "Timeout Error")];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
}
exports.impatientFetch = impatientFetch;
